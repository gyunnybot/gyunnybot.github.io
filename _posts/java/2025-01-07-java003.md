...
try 블록에 인자(Argument)로 전달되는 클래스는 반드시 <span style="color: rgb(3, 150, 150); font-weight: bold;">`AutoCloseable`</span> 인터페이스를 구현해야 합니다. 즉, <span style="color: rgb(3, 150, 150); font-weight: bold;">`close()`</span> 메서드를 재정의해야 합니다.
