...
커널이 제공하는 시스템 호출은 매우 제한적이기 때문에, 운영체제는 사용자 프로세스에게 API를 제공합니다. 사용자는 API를 활용해 편리하게 시스템 호출을 발생시켜 컴퓨터 자원에 접근할 수 있습니다. 사용자 프로세스가 자발적으로 커널 모드에 진입할 수 있는 유일한 수단은 시스템 호출입니다.